...
- [x] 03-04-PLAN.md — Column CRUD commands (add, rename, reorder, delete with safe item handling)
...
- [x] 04-03-PLAN.md — Item move/reorder, board view command with Kanban layout, register all commands in index.ts
...
- [ ] 05-02-PLAN.md — Sidebar navigation, workspace/board routes, TanStack Query hooks, workspace list page
